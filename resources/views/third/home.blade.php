...
<div class="container-fluid">
    ...
    <div class="text-center">
      <br>
      <h2 ><i class="fa-solid fa-gear mr-2"></i>Crear y Editar Terceros</h2>
      <br>
    </div>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    <h4><i class="fa-solid fa-business-time mr-2"></i>Agregar Tercero</h4>
                </div>
                <div class="card-body">
                    ...
                    <form id="addThirdEntry" method="POST"  action="{{ route('third.entry.add') }}">
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" name="cedula" id="cedula" class="form-control form-control-sm number-lg" id="exampleInputEmail1"  placeholder="">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">Nombre y apellido <small class="text-danger">(Obligatorio)</small></label>
                          <input type="text" name="nombre" id="nombre" class="form-control form-control-sm number-lg" id="exampleInputPassword1" placeholder="">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Dirección </label>
                            <input type="text" name="direccion" id="direccion" class="form-control form-control-sm number-lg" id="exampleInputPassword1" placeholder="">
                          </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Telefono</label>
                            <input type="number" name="telefono" id="telefono" class="form-control form-control-sm number-lg" id="exampleInputPassword1" placeholder="">
                          </div>
                          <div class="form-group">
                            ...
                            <select id="inputState" name="actividad" id="actividad" class="form-control form-control-sm number-lg listActivty">
                          ...
                          <div class="form-group">
                            ...
                            <textarea name="mas" id="mas" class="form-control form-control-sm number-lg" name="" id="" cols="30" rows="10"></textarea>
                          </div>
                        <button type="submit" class="btn btn-primary btn-sm"><i class="fa-solid fa-hand-pointer mr-2"></i>Agregar</button>
                      </form>
